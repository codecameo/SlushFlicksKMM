...
import com.sifat.slushflicks.data.remote.ApiEndPoint.Companion.TOP_RATED_MOVIE_URL
import com.sifat.slushflicks.data.remote.ApiEndPoint.Companion.TOP_RATED_TV_URL
...
import com.sifat.slushflicks.data.remote.ApiEndPoint.Companion.TV_SHOW_RECOMMENDATION_URL
...
import com.sifat.slushflicks.data.remote.ApiRequest.Companion.PATH_TV_SHOW_ID
...
class ApiEndPoint {
    companion object {
        ...
        const val TV_SHOW_RECOMMENDATION_URL = "tv/{$PATH_TV_SHOW_ID}/recommendations"
        const val TV_SHOW_SIMILAR_URL = "tv/{$PATH_TV_SHOW_ID}/similar"
